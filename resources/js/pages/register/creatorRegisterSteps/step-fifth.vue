      ...
      <div class="row">
        <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
          ...
          <div class="buttons-area">
            <a class="cancel-link pointer" @click="back()">
...
export default {
  ...
  methods: {
    validationStepSocialMedia() {
      ...
      formData.append("backgroundUri", this.creatorParam.profileData.profileBackgroundImage);
      formData.append("avatarUri", this.creatorParam.profileData.profilePictureImage);
      formData.append("firstName", this.creatorParam.firstName);
      formData.append("lastName", this.creatorParam.lastName);
      formData.append("accountType", this.creatorParam.accountType);
      formData.append("preferredPronoun", this.creatorParam.displayName);
      formData.append("password", this.creatorParam.password);
      formData.append("password_confirmation", this.creatorParam.password_confirmation);
      formData.append("contentPreferenceWritten", this.creatorParam.selected.includes(1) ?  1 : 0);
      formData.append("contentPreferenceAudio", this.creatorParam.selected.includes(2) ?  1 : 0);
      formData.append("contentPreferenceVisual", this.creatorParam.selected.includes(3) ?  1 : 0);
      formData.append("contentPreferenceEvents", this.creatorParam.selected.includes(4) ?  1 : 0);
      formData.append("email", this.creatorParam.email);
      formData.append("location", this.creatorParam.location);
      formData.append("dateOfBirth", this.creatorParam.dateOfBirth);
      formData.append("biography", this.creatorParam.profileData.biography);
      formData.append("creativeTitle", this.creatorParam.profileData.creativeTitle);
      formData.append("socials", JSON.stringify(this.user.socials));

      if (this.stripe.stripeCheck == 1) {
        formData.append("subscriptionId", this.stripe.stripeData.plan);
      } else {
        formData.append("subscriptionId", 0);
      }

      axios
        .post(apiRoute + "/user", formData)
        .then(response => {
          if (_this.stripe.stripeCheck == 1) {
            axios
              .post(apiRoute + "/stripe/api", {
                userId: response.data.data.id,
                stripe: _this.stripe.stripeData
              })
              .then(response => {})
              .catch(error => {});
          }
